...
/**
 * Tracks rolling stats for NaturalSpawner block state caching.
 */
public class SpawnCheckCacheTracker {
    ...
    public SpawnCheckCacheTracker(Yasui plugin, YasuiConfig config) {
        this.plugin = plugin;
        this.config = config;
    }
    ...
    public int getCacheSize() {
        return SpawnCheckNmsHook.getCacheSize();
    }
    ...
    private void flushStats() {
        ...
        updateRollingBuckets(System.currentTimeMillis());
        long[] stats = SpawnCheckNmsHook.drainStats();
